...
const env = process.env.NODE_ENV===null || typeof process.env.NODE_ENV ==='undefined'?'development':process.env.NODE_ENV;
...
const variables = {
    'production':{
        keyterpillar:{
            abi:keyterpillarAbi,
            address:'0xa04ec2d89aab8dbc4228572251e151956ad3529f830b26a9bcb64356532e676d', //todo deploy to prod
        }
    },
    'development':{
        keyterpillar:{
            abi:keyterpillarAbi,
            address:'0xa04ec2d89aab8dbc4228572251e151956ad3529f830b26a9bcb64356532e676d',
        }
    },
}
